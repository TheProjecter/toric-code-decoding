...
Toric code threshold simulator that assumes that syndrome measurements are imperfect.
...
The last lines determine the error probability of the syndrome measurements.
