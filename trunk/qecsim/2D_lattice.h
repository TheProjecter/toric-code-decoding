...
#include <inttypes.h>
#include "operator.h"
#include "blossom5-v2.04.src/PerfectMatching.h"
#include "blossom5-v2.04.src/GEOM/GeomPerfectMatching.h"
...
class Vertex //2 spatial, 1 temporal
{
public:
    int x;
    int y;
    ...
    Vertex (int newX, int newY, int newT=0);
    ~Vertex (void) { }
};
...
public:
    ...
    Lattice (int newXSize, int newT=0);
    ~Lattice (void);
